...
- (void)updateViews
{
	...
	if (orientation == UIDeviceOrientationPortrait)
	{
		...
		self.frameView.frame = CGRectMake(0, 0, screenWidthCamera, screenHeightCamera);
	}
	else if (orientation == UIDeviceOrientationLandscapeLeft)
	{
		self.frameView.transform = CGAffineTransformMakeRotation(pi * (90) / 180.0f);
		self.frameView.frame = CGRectMake(screenWidthCamera - screenHeightCamera, 0, screenHeightCamera, screenHeightCamera);
	}
