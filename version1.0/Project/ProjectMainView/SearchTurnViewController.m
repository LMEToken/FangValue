...
@interface SearchTurnViewController ()

@end

@implementation SearchTurnViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_SEARCH_TURN];
    ...
    [server setObject:serverStr forKey:@"server-turn"];
    [server synchronize];
