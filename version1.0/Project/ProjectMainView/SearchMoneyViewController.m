...
@interface SearchMoneyViewController ()

@end

@implementation SearchMoneyViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_SEARCH_MONEY];
    ...
    [server setObject:serverStr forKey:@"server-money"];
    [server synchronize];
