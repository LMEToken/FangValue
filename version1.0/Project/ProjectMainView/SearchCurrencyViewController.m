...
@interface SearchCurrencyViewController ()
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_SEARCH_CURRENCY];
    ...
    [server setObject:serverStr forKey:@"server-currency"];
    [server synchronize];
