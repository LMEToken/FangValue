...
@interface SearchStageViewController ()

@end

@implementation SearchStageViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_SEARCH_STAGE];
    ...
    [server setObject:serverStr forKey:@"server-stage"];
    [server synchronize];
