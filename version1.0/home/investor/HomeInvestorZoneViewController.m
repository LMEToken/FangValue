//
//  HomeInvestorZoneViewController.m
//  FangChuang
//
...
@interface HomeInvestorZoneViewController ()

@end

@implementation HomeInvestorZoneViewController
...
-(void)initChooseButton{
    ...
    [[NetManager sharedManager] getProFilterOptWithusername:[[NSUserDefaults standardUserDefaults]objectForKey:@"tele"] apptoken:[[UserInfo sharedManager] apptoken] rflag:@"4" hudDic:nil success:^(id responseDic) {
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_INVEST_BUSINESS];
    ...
    [server setObject:serverStr forKey:@"server-zone-i"];
    [server synchronize];
