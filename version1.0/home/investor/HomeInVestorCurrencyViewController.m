//
//  HomeInVestorCurrencyViewController.m
//  FangChuang
//
...
@interface HomeInVestorCurrencyViewController ()

@end

@implementation HomeInVestorCurrencyViewController
...
{
    [[NetManager sharedManager] getProFilterOptWithusername:[[NSUserDefaults standardUserDefaults]objectForKey:@"tele"] apptoken:[[UserInfo sharedManager] apptoken] rflag:@"2" hudDic:nil success:^(id responseDic) {
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_INVEST_CURRENCY];
    ...
    [server setObject:serverStr forKey:@"server-currency-i"];
    [server synchronize];
