//
//  HomeEntreScaleViewController.m
//  FangChuang
//
...
@interface HomeEntreScaleViewController ()

@end

@implementation HomeEntreScaleViewController
...
-(void)initChooseButton{
    ...
    [[NetManager sharedManager] getProFilterOptWithusername:[[NSUserDefaults standardUserDefaults]objectForKey:@"tele"] apptoken:[[UserInfo sharedManager] apptoken] rflag:@"6" hudDic:nil success:^(id responseDic) {
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_ENTRE_SCALE ];
    ...
    [server setObject:serverStr forKey:@"server-scale-e"];
    [server synchronize];
