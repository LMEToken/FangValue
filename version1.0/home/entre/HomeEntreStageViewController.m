//
//  HomeEntreStageViewController.m
//  FangChuang
//
...
@interface HomeEntreStageViewController ()

@end

@implementation HomeEntreStageViewController
...
-(void)initChooseButton{
    [[NetManager sharedManager] getProFilterOptWithusername:[[NSUserDefaults standardUserDefaults]objectForKey:@"tele"] apptoken:[[UserInfo sharedManager] apptoken] rflag:@"3" hudDic:nil success:^(id responseDic) {
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_ENTRE_STAGE ];
    ...
    [server setObject:serverStr forKey:@"server-stage-e"];
    [server synchronize];
