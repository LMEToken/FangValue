//
//  HomeEntreMoneryViewController.m
//  FangChuang
//
...
@interface HomeEntreMoneryViewController ()

@end

@implementation HomeEntreMoneryViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_ENTRE_MONEY];
    ...
    [server setObject:serverStr forKey:@"server-money-e"];
    [server synchronize];

    
    HomeEntreViewController *entreView=[[HomeEntreViewController alloc]init];
