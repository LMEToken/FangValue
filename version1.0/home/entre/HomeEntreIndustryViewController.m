//
//  HomeEntreIndustryViewController.m
//  FangChuang
//
...
@interface HomeEntreIndustryViewController ()

@end

@implementation HomeEntreIndustryViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:CLH_DEFAULT_ENTRE_BUSINESS ];
    ...
    [server setObject:serverStr forKey:@"server-business-e"];
    [server synchronize];
