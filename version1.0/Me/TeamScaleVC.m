...
@interface TeamScaleVC ()

@end

@implementation TeamScaleVC
...
- (void)viewDidLoad
{
    ...
    if ([[[UserInfo sharedManager] usertype]isEqualToString:@"1"]) {
        savearr = [NSArray arrayWithObjects:@"天使初创期",@"成长发展期", @"成熟期",@"收购",@"不限",nil];
          heradllable.text = @"投资人投资轮次";
    }else
    {
    savearr = [NSArray arrayWithObjects:@"5人以下",@"5-10人",@"11-30人",@"31-50人",@"51-100人",@"101-500人",@"500人-1000人",@"1000人以上", nil];
          heradllable.text = @"创业者团队";
    }
...
-(void)goback
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"changeTeam" object:typearr];
