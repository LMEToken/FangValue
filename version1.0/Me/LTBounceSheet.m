...
- (id) initWithHeight:(CGFloat) height bgColor:(UIColor*) color;
{
    ...
    CGFloat screenWidth1 = CGRectGetWidth(screenRect);
    CGFloat screenHeight1 = CGRectGetHeight(screenRect);
    
    self=[super initWithFrame:CGRectMake(0, screenHeight1-height+40, screenWidth1, height)];
    if(self){
        
        self.counter = 0;
        
        self.contentView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, screenWidth1, height)];
        ...
        self.centerHelperView = [[UIView alloc] initWithFrame:CGRectMake(screenWidth1/2, height, 0, 0)];
