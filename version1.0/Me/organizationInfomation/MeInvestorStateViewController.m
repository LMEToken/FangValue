//
//  MeInvestorStateViewController.m
//  FangChuang
//
...
@interface MeInvestorStateViewController ()

@end

@implementation MeInvestorStateViewController
...
-(void)initExplainTitle
{
    ...
    UILabel *explainLabel=[[UILabel alloc] initWithFrame:CGRectMake(15, 1, 100, 30)];
    explainLabel.text=@"选择融资状态";
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:@"me-zero-state"];
    ...
    EditordieViewController *editView=[[EditordieViewController alloc]init];
    editView.whereFromString=@"0";
...
{
    EditordieViewController *edit=[[EditordieViewController alloc]init];
    edit.whereFromString=@"0";
