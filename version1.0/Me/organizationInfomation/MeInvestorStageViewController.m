//
//  MeInvestorStageViewController.m
//  FangChuang
//
...
@interface MeInvestorStageViewController ()

@end

@implementation MeInvestorStageViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:@"me-zero-stage" ];
