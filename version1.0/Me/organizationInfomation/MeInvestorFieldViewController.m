//
//  MeInvestorFieldViewController.m
//  FangChuang
//
...
@interface MeInvestorFieldViewController ()

@end

@implementation MeInvestorFieldViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:@"me-zero-field"];
