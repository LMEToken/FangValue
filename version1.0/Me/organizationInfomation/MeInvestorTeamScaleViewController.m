//
//  MeInvestorTeamScaleViewController.m
//  FangChuang
//
...
@interface MeInvestorTeamScaleViewController ()

@end

@implementation MeInvestorTeamScaleViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:@"me-zero-scale" ];
