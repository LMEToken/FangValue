...
@interface MeEntreTurnViewController ()

@end

@implementation MeEntreTurnViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:@"me-first-turn"];
