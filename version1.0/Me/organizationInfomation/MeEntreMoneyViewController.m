...
@interface MeEntreMoneyViewController ()

@end

@implementation MeEntreMoneyViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:@"me-first-money"];
