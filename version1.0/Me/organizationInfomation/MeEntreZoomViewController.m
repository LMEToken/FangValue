...
@interface MeEntreZoomViewController ()

@end

@implementation MeEntreZoomViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:@"me-first-zoom" ];
