//
//  MeEntreCurrencyViewController.m
//  FangChuang
//
...
@interface MeEntreCurrencyViewController ()

@end

@implementation MeEntreCurrencyViewController
...
-(void)doClickRightButton:(UIButton *)btn
{
    ...
    [currency setObject:chooseStr forKey:@"me-first-currency"];
