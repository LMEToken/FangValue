...
- (id) initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
      ...
      //  topHalfBlackView.backgroundColor = [UIColor blackColor];
        topHalfBlackView.backgroundColor=[UIColor redColor];
...
//    UIImage* tmpImage = [[UIImage alloc] initWithCGImage:croppedScreenshot.CGImage
//                                                   scale:croppedScreenshot.scale
//                                             orientation:imageOrientation];
    UIImage* tmpImg = [UIImage imageWithCGImage:croppedScreenshot.CGImage scale:croppedScreenshot.scale orientation:imageOrientation];
    return tmpImg;
}
@end
