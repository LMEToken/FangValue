...
NSString *const TOGGLE_BASE_IMAGE        = @"64tongyong_icon01.png";
   ...
   toggleButtonType:(ToggleButtonType)aButtonType
{
    ...
    if (self) {
        ...
        [_toggleBase setFrame:CGRectMake(20, 0, 40, 20)];
        [_toggleBase setContentMode:UIViewContentModeScaleAspectFit];
...
- (void)onLeftButton:(id)sender
{
    ...
    [self.toggleDelegate selectLeftButton:self];
}
...
- (void)onRightButton:(id)sender
{
    ...
    [self.toggleDelegate selectRightButton:self];
}
