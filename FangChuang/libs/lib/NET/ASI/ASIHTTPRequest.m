...
//            [self setCompressedPostBody:postData];
...
//    [self performSelector:@selector(callBlock:) withObject:nil];
...
//           [self performSelector:@selector(requestReceivedResponseHeaders:) withObject:nil];
}
...
//       [self performSelector:@selector(askDelegateForProxyCredentials) withObject:nil];
...
//       r [self performSelector:@selector(askDelegateForCredentials) withObject:nil];
...
//		[self performSelectorOnMainThread:@selector(requestWillRedirectToURL:) withObject:newURL waitUntilDone:[NSThread isMainThread]];
       [self performSelector:@selector(requestWillRedirectToURL:) withObject:nil];
		return true;
	}
	return false;
}
...
//			[self performSelectorOnMainThread:@selector(passOnReceivedData:) withObject:data waitUntilDone:[NSThread isMainThread]];
            [self performSelector:@selector(passOnReceivedData:) withObject:nil];
