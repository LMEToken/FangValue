...
- (UIImageView*)getBubbleViewByMessage:(ZBMessage *)message{
    ...
    switch (message.messageType)
    {
        ...
        case ZBBubbleMessageVoice:
        {
            ...
            bubbleView.frame = CGRectMake(0.0f, 0.0f, 60, 40);
        ...
        {
          OHAttributedLabel *messageLabel = [[OHAttributedLabel alloc]initWithFrame:CGRectMake(10, 2, 200, 500)];
            [messageLabel  setFont:[UIFont fontWithName:KUIFont size:10]];
          [self creatAttributedLabel:message.text Label:messageLabel];
//            UITextView *messageLabel= [[ UITextView alloc]initWithFrame:CGRectMake(10, 2, 200, 500)];
//            messageLabel.backgroundColor = [UIColor clearColor];
//            messageLabel .text =message.text;
       
           [CustomMethod drawImage:messageLabel];
        
            bubbleView.frame = CGRectMake(0.0f,0.0f,CGRectGetWidth(messageLabel.frame)+20.0f,CGRectGetHeight(messageLabel.frame)+20.0f);
...
-(void)creatAttributedLabel:(NSString *)text Label:(OHAttributedLabel *)label{
    ...
    [label setFont:[UIFont fontWithName:KUIFont size:13]];
    ...
    labelRect.size.width = [label sizeThatFits:CGSizeMake(220, CGFLOAT_MAX)].width;
    labelRect.size.height = [label sizeThatFits:CGSizeMake(220, CGFLOAT_MAX)].height;
