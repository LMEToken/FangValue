...
//    
    [self shareFaceView];
   [self shareShareMeun];
//    UIButton *my = [[UIButton alloc]initWithFrame:CGRectMake(0.0f,  self.view.frame.size.height - inputViewHeight,self.view.frame.size.width,inputViewHeight)];
...
//        UIButton *sharePicItem = [[ZBMessageShareMenuItem alloc]initWithNormalIconImage:[UIImage imageNamed:@"sharemore_pic_ios7"]
//                                                                                                title:@"照片"];
//   
//   
